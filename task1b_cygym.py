...
from cygym import CyMountainCarEnv

# Import and initialize Mountain Car Environment
# Adding a timelimit to our environment
env = TimeLimit(CyMountainCarEnv(), max_episode_steps=200)
...
# plt.title('Average Reward vs Episodes: after optimization')
...
# plt.title('Average Time vs Episodes: after optimization')

plt.savefig('results_after.jpg')
plt.close()
